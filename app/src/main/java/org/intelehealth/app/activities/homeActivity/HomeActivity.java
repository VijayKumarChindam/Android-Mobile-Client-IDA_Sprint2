...
import org.intelehealth.app.activities.doctorListActivity.DoctorActivity;
import org.intelehealth.app.activities.followuppatients.FollowUpPatientActivity;
import org.intelehealth.app.activities.healthWorkerListActivity.HealthWorkerListActivity;
...
//        c1 = findViewById(R.id.cardview_newpat);
        ...
        c7 = findViewById(R.id.doctorlist_cardview);
        c8 = findViewById(R.id.healthworker_cardview);
...
//        manualSyncButton.setText(R.string.refresh);
        ...
        c8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(HomeActivity.this, HealthWorkerListActivity.class);
                startActivity(intent);
